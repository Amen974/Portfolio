...
const Projects = () => {
  ...
  return (
    <section className="uppercase pt-[15vw] pb-[10vw] px-[3vw] relative sectoion">
      <p className="text-[0.8vw] text-end">+ Selected Projects</p>
      <div className="absolute top-[12.5vw] left-[6vw]" ref={robot}><span ref={say} className="absolute text-[0.8vw] text-[#da7756] top-[-0.5vw] left-[1.5vw]">nice</span><Robot size={5} state="Move" animate={isScrollAnimate} /></div>
      {projects.map((p, i) => (
        <div key={p.id}
          className="pb-[5vw] flex opacity-60 hover:opacity-100 duration-500"
        ...
        >
          ...
          <div className="px-[1.5vw] pt-[1.5vw] flex-4 border-t border-x border-[#da7756]">
